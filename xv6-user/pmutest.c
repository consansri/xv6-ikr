...
uint64 get_hpm_value(int hpm_no) {
  ...
  switch (hpm_no){
    ...
    case 11:
      ...
      break;
    case 12:
      asm volatile("csrr %0, hpmcounter12" : "=r" (x));
      break;
    case 13:
      asm volatile("csrr %0, hpmcounter13" : "=r" (x));
      break;
    case 14:
      asm volatile("csrr %0, hpmcounter14" : "=r" (x));
      break;
    case 15:
      asm volatile("csrr %0, hpmcounter15" : "=r" (x));
      break;
    case 16:
      asm volatile("csrr %0, hpmcounter16" : "=r" (x));
      break;
    case 17:
      asm volatile("csrr %0, hpmcounter17" : "=r" (x));
      break;
    case 18:
      asm volatile("csrr %0, hpmcounter18" : "=r" (x));
      break;
    case 19:
      asm volatile("csrr %0, hpmcounter19" : "=r" (x));
      break;
    case 20:
      asm volatile("csrr %0, hpmcounter20" : "=r" (x));
      break;
    case 21:
      asm volatile("csrr %0, hpmcounter21" : "=r" (x));
      break;
    case 22:
      asm volatile("csrr %0, hpmcounter22" : "=r" (x));
      break;
    case 23:
      asm volatile("csrr %0, hpmcounter23" : "=r" (x));
      break;
    case 24:
      asm volatile("csrr %0, hpmcounter24" : "=r" (x));
      break;
    case 25:
      asm volatile("csrr %0, hpmcounter25" : "=r" (x));
      break;
    case 26:
      asm volatile("csrr %0, hpmcounter26" : "=r" (x));
      break;
    case 27:
      asm volatile("csrr %0, hpmcounter27" : "=r" (x));
      break;
    case 28:
      asm volatile("csrr %0, hpmcounter28" : "=r" (x));
      break;
    case 29:
      asm volatile("csrr %0, hpmcounter29" : "=r" (x));
      break;
    case 30:
      asm volatile("csrr %0, hpmcounter30" : "=r" (x));
      break;
    case 31:
      asm volatile("csrr %0, hpmcounter31" : "=r" (x));
      break;
    default:
      x = 0;
  }
